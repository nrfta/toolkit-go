...
type Tag struct {
	...
	ProductIds types.StringArray `boil:"product_ids" json:"product_ids,omitempty" toml:"product_ids" yaml:"product_ids,omitempty"`
...
var TagWhere = struct {
	...
	ProductIds whereHelpertypes_StringArray
	CreatedAt  whereHelpertime_Time
}{
	ID:         whereHelperstring{field: "\"tags\".\"id\""},
	Name:       whereHelperstring{field: "\"tags\".\"name\""},
	ProductIds: whereHelpertypes_StringArray{field: "\"tags\".\"product_ids\""},
...
var (
	tagAllColumns            = []string{"id", "name", "product_ids", "created_at"}
	tagColumnsWithoutDefault = []string{"id", "name"}
	tagColumnsWithDefault    = []string{"product_ids", "created_at"}
