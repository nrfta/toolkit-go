...
var OrderWhere = struct {
	...
	ProductID:   whereHelperstring{field: "\"orders\".\"product_id\""},
...
var (
	orderAllColumns            = []string{"id", "user_id", "product_id", "quantity", "order_date", "shipped_date", "status"}
	orderColumnsWithoutDefault = []string{"id", "user_id", "product_id", "quantity", "status"}
	orderColumnsWithDefault    = []string{"order_date", "shipped_date"}
...
func (orderL) LoadProduct(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrder any, mods queries.Applicator) error {
	var slice []*Order
	var object *Order
...
// loaded structs of the objects. This is for an N-1 relationship.
func (orderL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrder any, mods queries.Applicator) error {
	var slice []*Order
	var object *Order
