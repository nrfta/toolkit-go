...
var UserWhere = struct {
	...
	OrganizationID: whereHelpernull_String{field: "\"users\".\"organization_id\""},
...
func (o *User) GetOrders() OrderSlice {
	if o == nil {
		return nil
	}
...
var (
	userAllColumns            = []string{"id", "email", "name", "role", "organization_id", "created_at"}
	userColumnsWithoutDefault = []string{"id", "email", "role"}
	userColumnsWithDefault    = []string{"name", "organization_id", "created_at"}
...
func (userL) LoadOrders(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
