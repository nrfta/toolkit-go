...
var ProductTableColumns = struct {
	...
	IsAvailable: "products.is_available",
...
var ProductWhere = struct {
	...
	Price:       whereHelpertypes_NullDecimal{field: "\"products\".\"price\""},
	IsAvailable: whereHelperbool{field: "\"products\".\"is_available\""},
	...
	Categories:  whereHelpertypes_StringArray{field: "\"products\".\"categories\""},
}
...
func (o *Product) GetOrders() OrderSlice {
	if o == nil {
		return nil
	}
...
var (
	productAllColumns            = []string{"id", "name", "description", "status", "price", "is_available", "created_at", "updated_at", "tags", "categories"}
	productColumnsWithoutDefault = []string{"id", "name", "status"}
	productColumnsWithDefault    = []string{"description", "price", "is_available", "created_at", "updated_at", "tags", "categories"}
...
func (productL) LoadOrders(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProduct any, mods queries.Applicator) error {
	var slice []*Product
	var object *Product
